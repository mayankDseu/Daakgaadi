...
export class CalculatorComponent  {
  ...
  email: this.email,// Use value property to get the input value
        ...
        this.http.post<any>('https://logistwork.onrender.com/api/todos', estimateData).subscribe(
          (response: any) => {
  ...
  console.log(this.estimateResult);
    ...
    sendConfirmationEmail() {
      ...
      this.http.post<any>('https://logistwork.onrender.com/api/estimate', emailData).subscribe(
        (response) => {
          this.updateStatus();
    ...
    updateStatus() {
      this.http.put<any>(`http://localhost:8000/api/reest/${this.generatedId}/isconfirm`, {}).subscribe(
        (response) => {
